...
ALGORITHM = "HS256"
ACCESS_TOKEN_EXPIRE_MINUTES = int(os.getenv("NOX_TOKEN_EXPIRE_MINUTES", "480"))  # 8 heures par défaut
...
class AuthUtils:
    ...
    @staticmethod
    def create_access_token(user: User, expires_delta: Optional[timedelta] = None) -> Dict[str, Any]:
