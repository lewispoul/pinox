...
with tabs[1]:
    ...
    code = st.text_area("Code Python","print('Hello from Nox Dashboard!')", height=160, key="python_code")
...
with tabs[2]:
    ...
    st.info("💡 Commandes interdites: rm, reboot, shutdown, mkfs, dd, mount, umount, kill, pkill, sudo")
