...
class MultiNodeDatabaseManager:
    ...
    def _initialize_pools(self) -> None:
        ...
        for node in self.nodes:
            try:
                ...
                logger.info(f"Connection pool created for {node.host}:{node.port} ({node.role.value})")
    ...
    def execute_write_query(self, 
                           query: str, 
                           params: Tuple = None, 
                           fetch_result: bool = False) -> Optional[List[Dict[str, Any]]]:
        """
    ...
    def execute_read_query(self, 
                          query: str, 
                          params: Tuple = None,
                          prefer_replica: bool = True) -> List[Dict[str, Any]]:
        """
