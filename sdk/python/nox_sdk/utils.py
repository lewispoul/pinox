...
class RequestSigner:
    ...
    @staticmethod
    def verify_signature(received_signature: str,
                        method: str,
                        url: str,
                        headers: Dict[str, str],
                        body: Optional[str],
...
__all__ = [
    'RetryConfig', 'CircuitBreakerConfig', 'RateLimiter', 'CircuitBreaker',
    'RetryHandler', 'RequestSigner', 'FileUploadHelper', 'CacheManager',
    'ConfigManager', 'LogHandler', 'ValidationUtils', 'SecurityUtils'
]
